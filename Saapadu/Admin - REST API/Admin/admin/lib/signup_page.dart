...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Future<void> saveCredentials() async {
              ...
              Center(
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Lottie.asset("assets/img/Processing.json", height: 150),
                      SizedBox(height: 20),
                      Text(
                        "Saving Credentials...",
                        style: TextStyle(
    ...
    try {
      // encode the college name for the URL if it contains spaces
      final encodedCollegeName = Uri.encodeComponent(collegeName);
      final url = Uri.parse(
          "https://saapadu-groups-default-rtdb.asia-southeast1.firebasedatabase.app/AdminDatabase/$encodedCollegeName/CollegeCredentials.json"
      );
      ...
      if (response.statusCode == 200) {
        ...
        Get.snackbar("Error", "Failed to save credentials", backgroundColor: Colors.red, colorText: Colors.white);
      }
    } catch (e) {
          ...
          body: SingleChildScrollView(
            child: Container(
              ...
              padding: EdgeInsets.symmetric(
                horizontal: isSmallScreen ? width * 0.05 : width * 0.2,
